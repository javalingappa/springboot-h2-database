...
public class SwaggerConfig {
    ...
    public Docket swaggerApi() {
        ...
        String contactName = "Product Catalog Admin";
        String contactEmail = "";
        Contact contact = new Contact(contactName, "", contactEmail);
        ApiInfo apiInfo = new ApiInfoBuilder().version("1.0")
                .description("Product Catalog Admin which provide an option to end user to save and retrieve the products in the product catalog")
                .title("Product Catalog Service").version("1.0.0")
                .license("Commercial")
